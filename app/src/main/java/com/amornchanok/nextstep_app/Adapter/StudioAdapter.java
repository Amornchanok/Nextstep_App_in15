...
public class StudioAdapter extends RecyclerView.Adapter<StudioAdapter.categoryadapterViewHolder> {


    public  Context c;
    public  ArrayList<Studios> arrayList;
    public StudioAdapter(Context c, ArrayList<Studios> arrayList)
    {
            this.c=c;
    ...
    public void onBindViewHolder(categoryadapterViewHolder holder, int i) {
        ...
        Studios categoryitem = arrayList.get(i);
